...
/**
 * Created by huang_xw on 2016/5/6.
...
@Entity @Table(name = "t_element_tpl", schema = "", catalog = "test") public class TElementTplEntity {
    ...
    @Basic @Column(name = "lib_path") public String getLibPath() {
        return libPath;
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        if (params != null ? !params.equals(that.params) : that.params != null)
            return false;
        if (libPath != null ? !libPath.equals(that.libPath) : that.libPath != null)
            return false;
    ...
    @Override public int hashCode() {
        ...
        result = 31 * result + (libPath != null ? libPath.hashCode() : 0);
        return result;
    }
}
