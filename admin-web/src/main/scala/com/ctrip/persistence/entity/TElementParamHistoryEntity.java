 ...
 * web:www.ctrip.com
 */
@Entity @Table(name = "t_element_param_history", schema = "", catalog = "test")
public class TElementParamHistoryEntity {
    private long id;
    ...
    @Override public boolean equals(Object o) {
        ...
        TElementParamHistoryEntity that = (TElementParamHistoryEntity) o;
