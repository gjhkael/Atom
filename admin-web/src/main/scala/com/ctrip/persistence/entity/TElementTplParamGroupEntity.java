 ...
 * web:www.ctrip.com
 */
@Entity @Table(name = "t_element_tpl_param_group", schema = "", catalog = "test")
public class TElementTplParamGroupEntity {
    private long id;
    ...
    @Override public boolean equals(Object o) {
        ...
        TElementTplParamGroupEntity that = (TElementTplParamGroupEntity) o;
